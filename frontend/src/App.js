...
import './App.css';
import { Sun, Moon, Play, Plus, Star, Flame, X, User, LogOut, Check, Globe, Clapperboard } from 'lucide-react';
...
const App = () => {
  ...
  // Movie state
  const [movies, setMovies] = useState({ trending: [], originals: [], popular: [], bollywood: [], hollywood: [], watchlist: [] });
  const [movieErrors, setMovieErrors] = useState({ trending: null, originals: null, popular: null, bollywood: null, hollywood: null, watchlist: null });
        ...
        {loading && activeCategory !== 'watchlist' ? (
          ...
          <div className="empty-state">
            ...
            <button
              ...
              onClick={() => activeCategory === 'watchlist' ? fetchWatchlist() : fetchMovies()}
            >
              Try Again
            </button>
          </div>
